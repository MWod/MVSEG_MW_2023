...
def run():
    input_data_path = p.parsed_mvseg_path / "Shape_256_256_256"
    output_data_path = p.parsed_mvseg_path / "ElasticShape_256_256_256"
    input_csv_path = p.parsed_mvseg_path / "training_dataset.csv"
    output_csv_path = p.parsed_mvseg_path / "elasticaug_training_dataset.csv"
